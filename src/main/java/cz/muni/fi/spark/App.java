...
public class App {
    ...
    public static void main(String[] args) throws MissingArgumentException, InterruptedException {
        ...
        LongAccumulator processedRecordsCounter = jssc.ssc().sparkContext().longAccumulator("processedRecordsCounter"); // accumulator used for performance monitoring in all tests
