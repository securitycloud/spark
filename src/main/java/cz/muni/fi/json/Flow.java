...
public class Flow implements Serializable {
    ...
    public String toString() {
        return "Flow{" + "date_first_seen=" + date_first_seen + ", date_last_seen=" + date_last_seen + ", duration=" + duration + ", src_ip_addr=" + src_ip_addr + ", dst_ip_addr=" + dst_ip_addr + ", src_port=" + src_port + ", dst_port=" + dst_port + ", protocol=" + protocol + ", flags=" + flags + ", tos=" + tos + ", packets=" + packets + ", bytes=" + bytes + '}';
    }
}
